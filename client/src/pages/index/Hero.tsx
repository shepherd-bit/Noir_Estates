          ...
          <div className="pt-4 flex items-center space-x-4">
            <div className="flex -space-x-2 overflow-hidden">
              ...
              <div className="inline-block h-9 w-9 rounded-full ring-2 ring-[#FBF9F5] bg-gray-200 overflow-hidden">
                <img src="" alt="Collector 1" className="h-full w-full object-cover" />
              </div>
              <div className="inline-block h-9 w-9 rounded-full ring-2 ring-[#FBF9F5] bg-gray-200 overflow-hidden">
                <img src="" alt="Collector 2" className="h-full w-full object-cover" />
              </div>
              <div className="inline-block h-9 w-9 rounded-full ring-2 ring-[#FBF9F5] bg-gray-200 overflow-hidden">
                <img src="" alt="Collector 3" className="h-full w-full object-cover" />
              </div>
            </div>
