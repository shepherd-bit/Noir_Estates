...
export default function Navbar({ liveCount = 0, onNavigate, onListProperty }: NavbarProps) {
  return (
    <motion.header 
      ...
      className="w-full bg-[#FBF9F5] border-b border-gray-200/80 sticky top-0 z-50 shadow-[0_10px_30px_rgba(0,0,0,0.06)]"
    >
      <div className="max-w-7xl mx-auto px-8 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-6">
          ...
          <button 
            ...
            className="bg-black text-white px-5 py-2.5 rounded-full text-xs font-semibold uppercase tracking-wider hover:bg-gray-800 transition-all shadow-md hover:shadow-lg"
          >
            List Property
          </button>
        </div>
